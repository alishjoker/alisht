...
BOT : Alish Joker
SUPPORT BY : caspian ™ 
Caspian ™ bot Alish Joker | Vahid Vahshi
"""
KAC=[cl,ki,kk,kc]
...
admin=["uc89d57ef083cc9ed1672bde3e877e5e4","uc8e2c2b906e2322592c6d8f91a0957f7"]
creator=["uc89d57ef083cc9ed1672bde3e877e5e4"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Salam Khosh Omadi Page Mank Add Kn : https://line.me/R/ti/p/%40nlr3381q",
    "lang":"JP",
    "comment":"Salam Khosh Omadi Page Mank Add Kn : https://line.me/R/ti/p/%40nlr3381q",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "uc89d57ef083cc9ed1672bde3e877e5e4"}
					cl.sendMessage(msg)
#-----------------------------------------------
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By Alish Joker : line.me/joker.alish")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Id : https://line.me/R/ti/p/%40nlr3381q")
						print "DiLike"
					except:
							pass
				else:
